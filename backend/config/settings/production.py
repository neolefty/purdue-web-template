...
if AUTH_METHOD == 'saml':
    ...
    SAML_CONFIG = {
            ...
            'sp': {
                ...
                'endpoints': {
                    'assertion_consumer_service': [
                        (env('SAML_ACS_URL', default='https://yourapp.purdue.edu/saml/acs/'), saml2.BINDING_HTTP_POST),
                    ],
                    'single_logout_service': [
                        (env('SAML_SLS_URL', default='https://yourapp.purdue.edu/saml/sls/'), saml2.BINDING_HTTP_REDIRECT),
                    ],
                },
        ...
        'metadata': {
            'remote': [
                {
                    'url': env('SAML_METADATA_URL', default='https://www.purdue.edu/apps/account/saml/metadata.xml'),
                },
            ],
        },
